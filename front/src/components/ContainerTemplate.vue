                    ...
                    <div v-for="(msglist, index) in getMsgList(route.params.uuid)" :key="index"
                        ...
                        <div class="flex  " :class="msglist.reversion ? 'flex-row-reverse' : 'flex-row'">
                            <div
                                ...
                                <img :src="msglist.image" v-if="msglist.image" style="max-width: 200px;max-height: 200px;"
                                    alt="手相图">
                            ...
                            <n-modal style="width: 600px" class="custom-card" preset="card" v-model:show="showHand" title=""
                                size="huge">
                                <div class="hand"></div>
                                ...
                                <div style="display: flex;">
                                    ...
                                    <n-button ghost class=" h-auto dark:text-blue "
                    ...
                    <div class="  p-2">
                        <n-input-group>
                            ...
                            <input type="file" ref="fileInput" style="display: none;" @change="handleFileChange"
                                accept="image/*" />
                            <n-input show-count @keyup.enter="showHandFcn()" placeholder="请输入你的问题"
